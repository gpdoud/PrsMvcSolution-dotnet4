...
namespace PrsMvc.Controllers
{
    public class PurchaseRequestsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,UserId,Description,Justification,RejectionReason,DeliveryMode,Status,Total,Active")] PurchaseRequest purchaseRequest)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UserId,Description,Justification,RejectionReason,DeliveryMode,Status,Total,Active")] PurchaseRequest purchaseRequest)
        {
            if (ModelState.IsValid)
            {
