...
namespace PrsMvc.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,VendorId,PartNumber,Name,Price,Unit,PhotoPath,Active")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,VendorId,PartNumber,Name,Price,Unit,PhotoPath,Active")] Product product)
        {
            if (ModelState.IsValid)
            {
